...
<html>
  ...
  <body class="noselect" align="center" style="background-color:rgb(77, 77, 77)">
     
    <!--h2 style="color: teal;text-align:center;">Wi-Fi Camera &#128663; Control</h2-->
    
    <table id="mainTable" style="width:350px;margin:auto;table-layout:fixed" CELLSPACING=10>
      <tr>
        <img id="cameraImage" src="" style="width:390px;height:250px"></td>
      </tr> 
      <tr>
        <td></td>
      ...
      <tr>
        <td style="text-align:left"><b>Lanterna:</b></td>
        <td colspan=2>
          <div class="slidecontainer">
